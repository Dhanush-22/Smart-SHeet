...
const clientEntrypoints = [
  ...
  {
    name: 'CLIENT - Sidebar About Page',
    entry: './src/client/sidebar-emailVerification/index.js',
    filename: 'sidebar-emailVerification',
    template: './src/client/sidebar-emailVerification/index.html',
  },
  {
    name: 'CLIENT - Manage Credits',
    entry: './src/client/manage-credits/index.js',
    filename: 'manage-credits',
    template: './src/client/manage-credits/index.html',
  },
];
